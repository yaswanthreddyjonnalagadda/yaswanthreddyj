...
A minimalist personal portfolio site built with TanStack Start and deployed on Netlify. Features a dark navy design system, content-driven sections (About, Experience, Projects, Contact), and a full résumé page. No AI assistant — pure frontend showcase.
